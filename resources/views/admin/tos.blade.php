...
@section('content-wrapper')
  <div class="container-fluid">
    ...
    <h3>Term Of Service <a href="#" class="btn btn-info"><i class="fa fa-pencil"></i></a></h3>
    ...
    <p>CLEON berhak untuk merubah syarat dan ketentuan ini kapan saja, sangat dianjurkan memeriksa halaman ini sedikitnya sekali sebulan. CLEON berusaha untuk menyediakan layanan terbaik bagi anda, tetapi kami tidak akan memberikan toleransi terhadap kegiatan yang melanggar hukum atau segala bentuk penyimpangan yang dilakukan terhadap server kami. Petunjuk ringkas ini dibuat untuk melindungi kepentingan anda, pelanggan lainnya dan kami.</p> 	</div>
  </div>
@endsection
